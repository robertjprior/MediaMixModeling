'''
based off saturation from https://towardsdatascience.com/modeling-marketing-mix-using-pymc3-ba18dd9e6e68
...
class Hyperparams():
    def __init__(self, params = {
        ...
        'adstock__tv_pipe__saturation__gamma': UniformDistribution(0, 5.0),
        ...
        'adstock__radio_pipe__saturation__gamma': UniformDistribution(0, 5.0),
        ...
        'adstock__banners_pipe__saturation__gamma': UniformDistribution(0, 5.0),
    }):
        self.params = params