...
class Carryover(BaseEstimator, TransformerMixin):
    def __init__(self, strength=0.5, length=1, power=0.5):
    ...
    def fit(self, X, y=None):
        ...
        self.sliding_window_ = (
            self.strength ** (np.arange(self.length + 1)**self.power)
        ).reshape(-1, 1)
        return self
...
class Hyperparams():
    def __init__(self, params = {
        ...
        'adstock__tv_pipe__carryover__power': UniformDistribution(0, 3),
        ...
        'adstock__radio_pipe__carryover__power': UniformDistribution(0, 3),
        ...
        'adstock__banners_pipe__carryover__power': UniformDistribution(0, 3),
